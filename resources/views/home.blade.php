...
@section('content')
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6">
                        <div class="about-two__img">
                            ...
                            <div class="about-two__video wow fadeInRight" data-wow-delay="0ms"
                                data-wow-duration="1500ms">
        ...
        <section class="services-two">
            <div class="services-two__bg" style="background-image: url(assets//img/background/services-v2-bg.jpg);">
            </div>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            ...
                            <div class="services-two__single">
                                <div class="services-two__single-img">
                                    <div class="inner">
                                        <img src="assets/img/service/service-v2-img1.jpg" alt="">
                                    </div>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="services-two__single">
                                <div class="services-two__single-img">
                                    <div class="inner">
                                        <img src="assets/img/service/service-v2-img3.jpg" alt="">
                                    </div>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="services-two__single">
                                <div class="services-two__single-img">
                                    <div class="inner">
                                        <img src="assets/img/service/service-v2-img4.jpg" alt="">
                                    </div>
                            ...
                            <div class="testimonials-two__single">
                                ...
                                <div class="testimonials-two__single-bottom">
                                    ...
                                    <div class="content-box">
                                        ...
                                        <p>Cargo transport is best porro quisquam Many desktop publishing packages and
                                            web
        ...
        <section class="pricing-one">
            <div class="pricing-one__bg" style="background-image: url(assets/img/background/pricing-v1-bg.jpg);"></div>
            <div class="container">
        ...
        <section class="faq-one faq-one--two">
            ...
            <div class="faq-one__bg" style="background-image: url(assets/img/resource/faq-v2-bg.jpg);"></div>
            <div class="container">
                <div class="row">
                    <!-- Start Faq One Faq-->
                    <div class="col-xl-6">
                ...
                <div class="row">
                        ...
                        <div class="project-two__single">
                            <div class="project-two__single-img">
                                <div class="inner">
                                    ...
                                    <div class="btn-box">
                                        <a href="project-details.html"><span class="icon-right-arrow-5"></span></a>
                                    </div>
                                    <div class="overlay-content">
                                        <p>Ocean Freight</p>
                                        <h2><a href="project-details.html">Transport for Product</a></h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-3 col-lg-3 wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <div class="project-two__single">
                            <div class="project-two__single-img">
                                <div class="inner">
                                    <img src="assets/img/project/project-v2-img4.jpg" alt="">
                                    <div class="btn-box">
                                        <a href="project-details.html"><span class="icon-right-arrow-5"></span></a>
                                    </div>
                                    <div class="overlay-content">
                    ...
                    <div class="col-xl-3 col-lg-3 wow fadeInUp" data-wow-delay="100ms" data-wow-duration="1500ms">
                        <div class="project-two__single">
                            <div class="project-two__single-img">
                                <div class="inner">
                                    <img src="assets/img/project/project-v2-img5.jpg" alt="">
                                    <div class="btn-box">
                                        <a href="project-details.html"><span class="icon-right-arrow-5"></span></a>
                                    </div>
                                    <div class="overlay-content">
                    ...
                    <div class="col-xl-6 col-lg-6 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <div class="project-two__single">
                            <div class="project-two__single-img">
                                <div class="inner">
                                    <img src="assets/img/project/project-v2-img6.jpg" alt="">
                                    <div class="btn-box">
                                        <a href="project-details.html"><span class="icon-right-arrow-5"></span></a>
                                    </div>
                                    <div class="overlay-content">
        ...
        <section class="team-two">
            <div class="team-two__bg" style="background-image: url(assets/img/background/team-v2-bg.jpg);"></div>
            <div class="container">
                <div class="sec-title-two">
                    <div class="sub-title">
                        <h5>Our Stuff</h5>
                ...
                <div class="swiper-container team-two__slider">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            ...
                            <div class="team-two__single">
                                <div class="team-two__single-bg"
                                    style="background-image: url(assets/img/team/team-v2-single-bg1.jpg);"></div>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="team-two__single">
                                <div class="team-two__single-bg"
                                    style="background-image: url(assets/img/team/team-v2-single-bg2.jpg);"></div>
                                <div class="team-two__single-img">
                                    <div class="inner">
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="team-two__single">
                                <div class="team-two__single-bg"
                                    style="background-image: url(assets/img/team/team-v2-single-bg3.jpg);"></div>
                                <div class="team-two__single-img">
                                    <div class="inner">
            ...
            <div class="container">
                <div class="cta-two__inner">
                    ...
                    <div class="cta-two__inner-box">
                        <div class="title-box">
                            <p>GEt in touch</p>
                            <h2>Looking for the best logistics <br> transport services</h2>
                        </div>

                        <div class="btn-box">
                            <a class="thm-btn" href="#">
                                <span class="txt">Request a Quote</span> <i class="icon-right-arrow"></i>
                            </a>
                        </div>
                    </div>
                </div>
